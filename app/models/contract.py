...
class DepartmentType(str, enum.Enum):
    """Bank departments (single source for contracts, users, and dropdowns)."""

    IT_OPERATIONS = "IT - Operations"
    COMPLIANCE_DEPARTMENT = "Compliance Department"
    FINANCE = "Finance"
    INTERNAL_AUDIT = "Internal Audit"
    HUMAN_RESOURCES = "Human Resources"
    EXECUTIVE_OFFICE = "Executive Office"
    INSURANCE_DEPARTMENT = "Insurance Department"
    PREMISES_AND_FACILITIES = "Premises & Facilities"
    MARKETING_DEPARTMENT = "Marketing Department"
    PAYMENT_OPERATIONS = "Payment Operations"
    RETAIL_BANKING = "Retail Banking"
    PAYMENT_STRATEGY_AND_SOLUTIONS = "Payment Strategy & Solutions"
    CARC = "CARC"
    CORPORATE_BANKING_MID_OFFICE = "Corporate Banking - Mid Office"
    SECURITY_DEPARTMENT = "Security Department"
    MANAGEMENT_TEAM = "Management Team"
    SPECIAL_ASSETS = "Special Assets"
    CONTACT_CENTER = "Contact Center"
    CORPORATE_BANKING_CORPORATE_CREDIT = "Corporate Banking - Corporate Credit"
    CREDIT_RISK = "Credit Risk"
    ARCHIVING_SERVICES = "Archiving Services"
    PROJECT_MANAGEMENT_TEAM = "Project Management Team"
    IT_PROJECTS = "IT - Projects"
    KYC_DUE_DILIGENCE = "KYC Due Diligence"
    PBIO = "PBIO"
    ORCO_GROUP_NV = "ORCO Group N.V."
    BUSINESS_CONTINUITY_MANAGEMENT = "Business Continuity Management"
    MANAGEMENT_BOARD = "Management Board"
    INTEGRITY = "Integrity"
    PLATINUM_BANKING = "Platinum Banking"
    OBAB_IT = "OBAB IT"
    OBAB_SECURITY = "OBAB Security"
    OBAB_RETAIL = "OBAB Retail"
    OBAB_PBIO = "OBAB PBIO"
    OBAB_PAYMENT_STRATEGY_AND_SOLUTIONS = "OBAB Payment Strategy & Solutions"
    OBAB_PAYMENT_OPERATIONS = "OBAB Payment Operations"
    OBAB_PREMISES_AND_FACILITIES = "OBAB Premises & Facilities"
    OBAB_INTERNAL_AUDIT = "OBAB Internal Audit"
